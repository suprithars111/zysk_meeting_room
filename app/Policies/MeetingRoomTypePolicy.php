...
class MeetingRoomTypePolicy
{
    ...
    {
        return $user->hasPermissionTo('list meetingroomtypes');
    }
    ...
    {
        return $user->hasPermissionTo('view meetingroomtypes');
    }
    ...
    {
        return $user->hasPermissionTo('create meetingroomtypes');
    }
    ...
    {
        return $user->hasPermissionTo('update meetingroomtypes');
    }
    ...
    {
        return $user->hasPermissionTo('delete meetingroomtypes');
    }
